...
const Documents = [
  {
    ...
    citation:
      "Petr Valenta; (2020), Recoil Effects on Reflection from Relativistic Mirrors in Laser Plasmas, DOI:10.1142/s0217751x19430103",
    isPublic: true,
    type: "Publication",
  ...
  },
  {
    ...
    summary:
      "OSIRIS 2D PIC simulation of gamma radiation and electron-positron pair production in a head-on collision of ultra-intense laser pulse (2.5 x 1023 W/cm2, 150 fs) with 3.9 GeV electron beam previously accelerated within the plasma channel.",
    datasets: [],
    members: [
      {
        name: "Dr. Who",
  ...
  },
  {
    ...
    summary:
      "2D particle-in-cell simulation of the interaction of high-intensity laser pulse (parameters are relevant to 100 PW class laser) with a double layer deuterium-hydrogen target. The laser pulse initiates instability on the interface between deuterium (blue) and proton (purple to yellow) layers. It results in generation of collimated quasi-monoenergetic proton bunch of high energy (yellow). The bunch can be also recognized in the proton energy spectra near the end of the simulation.",
    datasets: [],
    members: [
      {
        name: "Dr. Who",
