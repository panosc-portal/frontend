...
set ignorecase
set mouse=a
set operatorfunc=<SNR>41_go
set pyxversion=3
set ruler
set runtimepath=~/.vim,~/.vim/plugged/vim-easy-align,~/.vim/plugged/nerdtree,~/.vim/plugged/lightline.vim,~/.vim/plugged/nord-vim,~/.vim/plugged/auto-pairs,~/.vim/plugged/vim-commentary,~/.vim/plugged/ale,~/.vim/plugged/vim-jsx,~/.vim/plugged/vim-javascript,~/.vim/plugged/deoplete.nvim,~/.vim/plugged/nvim-yarp,~/.vim/plugged/vim-hug-neovim-rpc,~/.vim/plugged/deoplete-ternjs,~/.vim/plugged/ctrlsf.vim,~/.vim/plugged/vim-tmux-navigator,~/.vim/plugged/eslint,/usr/share/vim/vimfiles,/usr/share/vim/vim82,/usr/share/vim/vimfiles/after,~/.vim/plugged/vim-jsx/after,~/.vim/plugged/vim-javascript/after,~/.vim/plugged/ctrlsf.vim/after,~/.vim/after
set showtabline=2
set smartcase
...
%argdel
$argadd .
edit src/pages/DocumentPage.js
...
set winminwidth=0
set winwidth=1
exe 'vert 1resize ' . ((&columns * 63 + 159) / 319)
exe 'vert 2resize ' . ((&columns * 63 + 159) / 319)
exe 'vert 3resize ' . ((&columns * 63 + 159) / 319)
exe 'vert 4resize ' . ((&columns * 63 + 159) / 319)
exe 'vert 5resize ' . ((&columns * 63 + 159) / 319)
argglobal
let s:cpo_save=&cpo
set cpo&vim
...
silent! normal! zE
let s:l = 91 - ((29 * winheight(0) + 31) / 62)
...
wincmd w
argglobal
if bufexists("src/pages/DocumentsPage.js") | buffer src/pages/DocumentsPage.js | else | edit src/pages/DocumentsPage.js | endif
let s:cpo_save=&cpo
set cpo&vim
inoremap <buffer> <silent> <M-n> :call AutoPairsJump()a
inoremap <buffer> <silent> <expr> <M-p> AutoPairsToggle()
...
setlocal wrapmargin=0
silent! normal! zE
let s:l = 19 - ((10 * winheight(0) + 31) / 62)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
19
...
wincmd w
argglobal
if bufexists("src/components/newInstances.js") | buffer src/components/newInstances.js | else | edit src/components/newInstances.js | endif
let s:cpo_save=&cpo
set cpo&vim
inoremap <buffer> <silent> <M-n> :call AutoPairsJump()a
inoremap <buffer> <silent> <expr> <M-p> AutoPairsToggle()
...
wincmd w
argglobal
if bufexists("src/pages/DocumentPage.js") | buffer src/pages/DocumentPage.js | else | edit src/pages/DocumentPage.js | endif
let s:cpo_save=&cpo
set cpo&vim
inoremap <buffer> <silent> <M-n> :call AutoPairsJump()a
inoremap <buffer> <silent> <expr> <M-p> AutoPairsToggle()
...
setlocal wrapmargin=0
silent! normal! zE
let s:l = 92 - ((4 * winheight(0) + 31) / 62)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
92
...
wincmd w
argglobal
if bufexists("src/components/instanceDndHelper.js") | buffer src/components/instanceDndHelper.js | else | edit src/components/instanceDndHelper.js | endif
let s:cpo_save=&cpo
set cpo&vim
inoremap <buffer> <silent> <M-n> :call AutoPairsJump()a
inoremap <buffer> <silent> <expr> <M-p> AutoPairsToggle()
...
exe 'vert 5resize ' . ((&columns * 63 + 159) / 319)
tabnext 1
badd +33 src/utils/searchApi.js
badd +19 src/pages/DocumentsPage.js
badd +30 src/components/DocumentList.js
badd +4 .env
badd +19 src/utils/useApi.js
badd +20 src/utils/useSearchApi.js
badd +91 src/pages/DocumentPage.js
badd +18 ~/panosc-latest/express/src/index.js
badd +13 src/components/Document.js
badd +32 src/App.js
badd +0 src/components/newInstances.js
badd +0 src/components/instanceDndHelper.js
