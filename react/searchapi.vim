...
set winminwidth=0
set winwidth=1
exe 'vert 1resize ' . ((&columns * 61 + 96) / 193)
exe 'vert 2resize ' . ((&columns * 61 + 96) / 193)
exe '3resize ' . ((&lines * 31 + 32) / 64)
exe 'vert 3resize ' . ((&columns * 69 + 96) / 193)
exe '4resize ' . ((&lines * 30 + 32) / 64)
exe 'vert 4resize ' . ((&columns * 69 + 96) / 193)
argglobal
let s:cpo_save=&cpo
set cpo&vim
...
wincmd w
argglobal
if bufexists("src/utils/api.js") | buffer src/utils/api.js | else | edit src/utils/api.js | endif
let s:cpo_save=&cpo
set cpo&vim
inoremap <buffer> <silent> <M-n> :call AutoPairsJump()a
inoremap <buffer> <silent> <expr> <M-p> AutoPairsToggle()
...
wincmd w
argglobal
if bufexists("src/utils/searchApi.js") | buffer src/utils/searchApi.js | else | edit src/utils/searchApi.js | endif
let s:cpo_save=&cpo
set cpo&vim
inoremap <buffer> <silent> <M-n> :call AutoPairsJump()a
inoremap <buffer> <silent> <expr> <M-p> AutoPairsToggle()
...
exe 'vert 4resize ' . ((&columns * 69 + 96) / 193)
tabnext 1
badd +1 src/utils/useApi.js
badd +0 ./
badd +22 src/utils/useFetch.js
badd +4 src/utils/api.js
badd +1 src/utils/searchApi.js
badd +0 src/pages/DocumentPage.js
